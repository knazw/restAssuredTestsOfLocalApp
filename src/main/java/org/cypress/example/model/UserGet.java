...
public class UserGet {
    ...
    public UserGet(String id, String uuid, String firstName, String lastName, String username, String password, String email, String phoneNumber, String avatar, String defaultPrivacyLevel, int balance, String createdAt, String modifiedAt) {
        this.id = id;
        this.uuid = uuid;
